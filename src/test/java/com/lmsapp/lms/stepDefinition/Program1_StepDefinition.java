...
// Scenario 7 
		...
		public void admin_should_see_a_popup_open_for_adding_a_new_program_with_save_and_cancel_button_and_close_icon() {
...
//Scenario 10 
		...
		public void admin_clicks_edit_button_on_data_table_for_any_row() {
		 ...
		 System.out.println("Edit pop windows");  
		}
		...
		public void admin_clicks_edit_button_on_data_table_for_any_rows() {
			 System.out.println("Edit pop windows");  
		...
		public void Admin_enters_only_numbers_or_special_char_in_name_and_desc_column_and_gets_Error_message_alert() {
			programobj.validate_edit_invalid_input();
		...
		*/
		...
		public void admin_clicks_yes_button_on_the_alert() {
			programobj.validate_yesindelete();
		    
		}

		@Then("Then Admin gets a message Successful Program Deleted alert")
		public void then_admin_gets_a_message_successful_program_deleted_alert() {
